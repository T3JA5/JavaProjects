...
/* NOTE:
 * Need to ON Allow less secure apps to below link
 * https://myaccount.google.com/lesssecureapps
 * */

public class Email {

	private static String USER_NAME = "tejaslabhashetwar";  // GMail user name (just the part before "@gmail.com")
	private static String PASSWORD = "*******"; // GMail password
	private static String RECIPIENT = "tejaslabhashetwar@gmail.com";
